...
const Stats: React.FC = () => {
  ...
  const stats = [
    {
      ...
      tooltip: 'Total orders generated from "buy" and "order via WhatsApp" buttons on the catalog'
    },
    {
      label: 'Average Monthly ROI',
      value: '30x',
      description: '(On subscription cost)',
      icon: 'savings',
      color: 'from-[#b539e6] to-[#6200ee]',
      tooltip: 'Average monthly GMV / Essential plan subscription'
    },
    {
      label: 'New Daily Opportunities',
      value: '5 to 10',
      description: '(Generated by Redi AI)',
      icon: 'ads_click',
      color: 'from-[#b539e6] to-[#6200ee]',
      tooltip: 'New product sales opportunities generated by Redi AI'
    },
    {
      label: 'Increase in Sales',
      value: 'up to 30%',
      description: '(Via Redi channels)',
      icon: 'trending_up',
      color: 'from-[#b539e6] to-[#6200ee]',
      tooltip: 'Increased sales across channels managed by RediRedi - WhatsApp, Catalog, and Social Media'
    },
  ];
  ...
  return (
    <section className="bg-gradient-to-br from-[#f5f0ff] via-[#f8f5ff] to-[#faf8ff] py-7 md:py-8 px-4 md:px-6 relative">
      ...
      <div className="absolute inset-0 bg-[url('/sales-platform/pattern.svg')] opacity-5"></div>
      ...
      <div className="max-w-7xl mx-auto relative">
        <ScrollSection className="text-center mb-6 md:mb-8">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-4xl font-bold text-slate-900 mb-4">
            Real results for daily Redi users
          </h2>
          <p className="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto">
            Metrics that demonstrate the real impact of our platform on your business
          </p>
        </ScrollSection>
